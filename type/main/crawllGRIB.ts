...
var targetHourString:string = '00';
var localRepoPath: string = "D:\\CWB-WRF-Download-Task";

let worker: CrawlGribDataWorker = new CrawlGribDataWorker({ targetHour: targetHourString, localRepoPath: localRepoPath });
